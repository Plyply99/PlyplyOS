...
### Install packages
dnf5 -y install cups cups-filters system-config-printer ghostscript gutenprint bluez bluez-cups blueman NetworkManager-wifi linux-firmware avahi avahi-dnsconfd firewalld firewall-offline-cmd distrobox htop  xwininfo glibc-locale-source glibc-langpack-en libva-utils
